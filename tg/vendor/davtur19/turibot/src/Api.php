...
abstract class Api implements ApiInterface
{
    ...
    public function sendChatAction($chat_id, string $action)
    {
        $args = [
            'chat_id' => $chat_id,
            'action' => $action
    ...
    public function setChatDescription($chat_id, string $description = null)
    {
        $args = [
            'chat_id' => $chat_id
        ];
    ...
    public function uploadStickerFile(int $user_id, \CURLFile $png_sticker)
    {
        $args = [
            'user_id' => $user_id,
    ...
    public function setPassportDataErrors(int $user_id, $errors)
    {
        $args = [
            'user_id' => $user_id,
            'errors' => $errors
