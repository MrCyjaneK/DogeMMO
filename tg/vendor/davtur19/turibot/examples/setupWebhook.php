...
if (
    isset($_POST["connections"]) and
    !(1 <= $_POST["connections"] and $_POST["connections"] <= 100)
) {
...
if (isset($_POST["yes"])) {
    ...
    echo "<p><input type=\"hidden\" name=\"link\" value=\"" .
    ...
    if (
        ($responseWebhook->description == "Webhook was set" or
            $responseWebhook->description == "Webhook is already set") and
        $response->ok == true
    ) {
        $username = $response->result->username;
        echo "Setup successful: <a href=\"http://t.me/" .
            $username .
            "\"> @" .
            $username .
            "</a>";
    ...
    echo "<p><input type=\"hidden\" name=\"api\" value=\"" .
        htmlspecialchars($api) .
        "\" /></p>";
    echo "<p><input type=\"hidden\" name=\"link\" value=\"" .
        htmlspecialchars($link) .
        "\" /></p>";
