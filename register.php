...
<!DOCTYPE html>
    ...
    <body style="max-width: 650px;">
        ...
        <form>
            ...
            <button onclick="submitRegister(); return false">Register</button>
        </form>
        ...
        <script>
            submitRegister = (() => {
                ...
                data = {
                    username: username,
                    password: password, // Yeah, we send plaintext version too. Sorry.
                    password_enc: password_enc,
                };
                var xhr = new XMLHttpRequest();
                xhr.open("POST", "<?= WEB ?>/ajax/register.php" , true);
